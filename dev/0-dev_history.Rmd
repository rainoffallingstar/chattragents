...
fusen::fill_description(
  ...
  fields = list(
    Title = "chattragents",
    Description = "agents for chattr package",
    `Authors@R` = c(
...
usethis::use_dev_package("mlverse/chattr")

agentlist <- list.files("inst/agents","*.txt") %>% 
  stringr::str_remove(.,".txt")
usethis::use_data(agentlist)

model_temple <- yaml::read_yaml("~/chattr/inst/configs/yi.yml")
usethis::use_data(model_temple)
```
